...
export const actionsList = {
    ...
    updateStudent: "[Students Detail Component] Update Student API",
    updateStudentSuccess: "[Students Detail Component] Update Student API Success",
    updateStudentFailure: "[Students Detail Component] Update Student API Failure",
}
...
export const updateStudent = createAction(actionsList.updateStudent, props<{ student: StudentsRecords }>());
export const updateStudentSuccess = createAction(actionsList.updateStudentSuccess, props<{ student: StudentsRecords }>());
export const updateStudentFailure = createAction(actionsList.updateStudentFailure, props<{ error: any }>());